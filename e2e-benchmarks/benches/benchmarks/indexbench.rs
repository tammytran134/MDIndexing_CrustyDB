...
fn setup_data_range_scan(bt: &mut Template, dim: usize) -> Vec<Vec<String>> {
    ...
    if dim == 2 {
        for i in 0..data_num {
            ...
            let num3 = rng.gen_range(0..MAX);
            let num4 = rng.gen_range(num3+1..MAX);
            sub_res.push(num1.to_string());
            sub_res.push(num2.to_string());
            sub_res.push(num3.to_string());
            sub_res.push(num4.to_string());
        ...
        for i in 0..data_num {
            ...
            sub_res.push(num3.to_string());
            sub_res.push(num4.to_string());
            sub_res.push(num5.to_string());
            sub_res.push(num6.to_string());
            res.push(sub_res.clone());
        }
    }
    res
